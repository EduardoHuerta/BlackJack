...
public class BlackJack {
    ...
    private static boolean autoData = true;
    ...
    private static void gameLoop() {
        ...
        do {
            ...
            System.out.print("| " + Consola.Color.PURPLE + "Ronda " + ++ronda + Consola.Color.RESET + " | " +
            ...
            if (croupier.getEstado() != JugadorEstado.GANAR_CON_BLACK_JACK) {
                ...
                while (jugadoresBlackJackQuePuedenTomarCartas.size()>0){
                    ...
                    System.out.println("Turno del jugador " + jugadorBlackJack + " de pedir cartas");
